	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?php echo base_url() ?>" class="logo">
				...
				<span class="logo-mini"><b>GIS</span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>SIGA</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="<?php echo base_url('assets/adminlte/dist/img/admin.png') ?>" class="user-image" alt="User Image">
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									...
									<div class="pull-right">
										<a href="<? echo base_url('login/do_logout') ?>" class="btn btn-default btn-flat">Sign out</a>
									</div>
								</li>
							</ul>
						</li>
