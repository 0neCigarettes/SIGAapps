...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <?php echo $title ?> Data Apotek
            <small>Data Apotek</small>
        </h1>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $title ?> Data Apotek</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <?php echo $url; ?>
                    ...
                    <div class="box-body">
                        <div class="form-group" hidden>
                            <input type="text" value="<?php echo $idSpbu ?>" name="id" class="form-control" id="exampleInputEmail1" placeholder="Kode Kecamatan">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo $lati ?>" name="lat" class="form-control" id="exampleInputEmail1" placeholder="Latitude">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Longitude</label>
                            <input type="text" value="<?php echo $longi ?>" name="long" class="form-control" id="exampleInputEmail1" placeholder="Latitude">
                        </div>
                    </div>
                    <!-- /.box-body -->
