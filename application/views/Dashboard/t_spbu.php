                        ...
                        foreach ($dataspbu as $data) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="submit" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-default<?php echo $data->id; ?>">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" align="center">
                                            <img src="<?php echo base_url('assets/adminlte/dist/img/trash.png') ?>" style="width: 100px; height: 100px" class="user-image" alt="User Image">
                                        </div>
